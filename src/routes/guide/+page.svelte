...
&lt;/main&gt;</code
		...
		<div class="step" data-aos="fade-right">
			...
			<div class="step-content">
				<h3>Add animations to elements</h3>
				<p>Two ways to configure your elements:</p>

				<div class="approach-mini">
					<h4>Option A: HTML attributes</h4>
					<p>Add <code>data-aos</code> attributes directly:</p>
					<pre><code
...
&lt;/div&gt;</code
				...
				<div class="approach-mini">
					<h4>Option B: Helper function <span class="badge">Type-safe</span></h4>
					<p>Use <code>toAosAttributes</code> for autocompletion and type safety:</p>
					<pre><code
							>&lt;script&gt;
...
&#125;)&#125;&gt;Animated&lt;/div&gt;</code
			...
			<p class="approach-note">
				Both produce the same result. Use <strong>Option A</strong> for simple cases. Use
				<strong>Option B</strong> when generating attributes dynamically (e.g., in loops or from data).
			</p>
		</div>
...
import 'svelte-aos/styles/easings.css';</code
	...
	<footer>
		...
		<p>
			<a href="/travel">Travel Agency Example</a>
		</p>
	</footer>
</main>
